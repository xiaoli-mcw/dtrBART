...
for (i in 1:rep){
    bart1 <- readRDS(file=paste0("~/BART/a3/results/bart2/bart1_",i,".RDS"))
...
jpeg(file="~/BART/a3/outputs/lin_cr2.jpg", width=480, height=480)
...
pdf(file="~/BART/a3/outputs/lin2.pdf", width=18, height=9)

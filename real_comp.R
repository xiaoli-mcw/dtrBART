...
ROC_b_stg2 <- timeROC(T=T_stg2, delta=delta2, marker=-rowMeans(res_b$yhat2optmean), cause=1, time=timepoint)
ROC_q_stg2 <- timeROC(T=T_stg2, delta=delta2, marker=-res_q$yhat2optmean, cause=1, time=timepoint)
...
ROC_b_stg1_b <- timeROC(T=T_stg1_b, delta=delta1_b, marker=-rowMeans(res_b$yhat1optmean), cause=1, time=timepoint)
ROC_q_stg1_b <- timeROC(T=T_stg1_b, delta=delta1_b, marker=-res_q$yhat1optmean, cause=1, time=timepoint)
...
ROC_b_stg1_q <- timeROC(T=T_stg1_q, delta=delta1_q, marker=-rowMeans(res_b$yhat1optmean), cause=1, time=timepoint)
ROC_q_stg1_q <- timeROC(T=T_stg1_q, delta=delta1_q, marker=-res_q$yhat1optmean, cause=1, time=timepoint)
...
ROC_b_stg1_agree <- timeROC(T=T_stg1_agree, delta=delta1_agree, marker=-rowMeans(res_b$yhat1optmean), cause=1, time=timepoint)
ROC_q_stg1_agree <- timeROC(T=T_stg1_agree, delta=delta1_agree, marker=-res_q$yhat1optmean, cause=1, time=timepoint)
